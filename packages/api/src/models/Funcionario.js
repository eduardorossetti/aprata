import FuncionarioBD from '../repository/FuncionarioRepository.js'
...
export default class Funcionario {
  ...
  async consultarOrientadores() {
    const funcionarioBD = new FuncionarioBD()
    const funcionarios = await funcionarioBD.consultarOrientadores()
    return funcionarios
  }

  async autenticar(usuario, senha) {
    const funcionarioBD = new FuncionarioBD()
    return await funcionarioBD.autenticar(usuario, senha)
  }
}
